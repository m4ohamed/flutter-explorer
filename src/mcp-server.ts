...
// Path to the index cache generated by the VS Code extension
const INDEX_PATH = path.join(process.cwd(), ".vscode", "flutter-explorer-index.json");
...
server.registerTool(
  ...
  async () => {
    try {
      ...
      return { content: [{ type: "text", text: "pubspec.yaml not found." }] };
    } catch (error) {
